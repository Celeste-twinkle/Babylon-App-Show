import{O as e,W as r,bk as n}from"./index-DGD8xEbd.js";import{s as l}from"./screenSpaceRayTrace-Chmkbf0s.js";const i="screenSpaceReflection2PixelShader",o=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=o);const c=[r,n,l];for(const t of c)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);const S={name:i,shader:o};export{S as screenSpaceReflection2PixelShader};
