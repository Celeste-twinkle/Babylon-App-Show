import{S as e}from"./index-D-9v0eiB.js";import"./mainUVVaryingDeclaration-LPyOWZcS.js";import"./ltcHelperFunctions-1H9cj-Rd.js";const o="pbrFragmentExtraDeclaration",d=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=d);const t="pbrHelperFunctions",g=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=g);const i="pbrDirectLightingSetupFunctions",E=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=E);const r="pbrDirectLightingFalloffFunctions",u=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=u);const a="pbrDirectLightingFunctions",D=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=D);const l="pbrIBLFunctions",L=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=L);const n="pbrBlockNormalGeometric",A=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=A);const f="pbrBlockImageProcessing",h=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=h);const c="pbrBlockPrePass",C=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=C);const s="pbrDebug",v=`#if DEBUGMODE>0
