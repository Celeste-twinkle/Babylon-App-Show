import{O as e,U as f,a4 as n,a5 as o}from"./index-CFD21-UM.js";const i="glowMapGenerationPixelShader",r=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=r);const l=[f,n,o];for(const a of l)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const s={name:i,shader:r};export{s as glowMapGenerationPixelShaderWGSL};
