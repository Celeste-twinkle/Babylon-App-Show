import{O as i,af as t,b8 as r,ag as a,bm as f}from"./index-B92au7sv.js";import{f as d,a as l}from"./fogFragment-BbGrhTTJ.js";import{i as s}from"./imageProcessingCompatibility-DtwhJVWW.js";const e="gridPixelShader",n=`#extension GL_OES_standard_derivatives : enable
...
`;i.ShadersStore[e]||(i.ShadersStore[e]=n);const c=[t,r,d,a,l,f,s];for(const o of c)i.IncludesShadersStore[o.name]||(i.IncludesShadersStore[o.name]=o.shader);const p={name:e,shader:n};export{p as gridPixelShader};
