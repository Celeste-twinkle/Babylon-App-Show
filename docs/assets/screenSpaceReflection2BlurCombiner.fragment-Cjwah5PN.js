import{O as e,W as o,bk as t}from"./index-1Zx_PTkb.js";import{s as n}from"./screenSpaceRayTrace-DYnSDpzP.js";const i="screenSpaceReflection2BlurCombinerPixelShader",l=`uniform sampler2D textureSampler; 
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=l);const c=[o,t,n];for(const r of c)e.IncludesShadersStore[r.name]||(e.IncludesShadersStore[r.name]=r.shader);const S={name:i,shader:l};export{S as screenSpaceReflection2BlurCombinerPixelShader};
