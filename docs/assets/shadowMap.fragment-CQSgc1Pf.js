import{O as e,cQ as o,a4 as p,a5 as c}from"./index-CQuAQaR3.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=s);const l={name:t,shader:s},i="shadowMapPixelShader",d=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=d);const M=[o,h,u,p,c,l];for(const a of M)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const P={name:i,shader:d};export{P as shadowMapPixelShaderWGSL};
