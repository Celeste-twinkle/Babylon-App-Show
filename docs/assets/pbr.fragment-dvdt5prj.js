import{v as e,W as z,X as K,ci as $,dn as q,ck as Z,af as J,a5 as j,O as Q,dp as ee,dq as ae,cl as ie,a1 as re,Y as ne,dr as fe,ds as oe,cm as te,cn as ce,cj as le,ag as de,co as se,aU as Ee,aT as Re}from"./thinEngine-C6TEorKP.js";import{p as Se,o as me,t as Ce,d as ue,a as ve}from"./oitFragment-DwuTwefB.js";import{p as Ie}from"./pbrUboDeclaration-DoYC7UBG.js";import{m as Ae}from"./mainUVVaryingDeclaration-Bjufdkcf.js";import{p as pe,a as Ne,b as Oe,c as Te,d as Le,e as _e,f as Me,g as De,h as Fe}from"./pbrDebug-BzZhMijd.js";import{l as ge,s as Pe,a as he,c as Ue}from"./clusteredLightingFunctions-Dq6q3jg1.js";import{f as be}from"./fogFragmentDeclaration-DcfwxThS.js";import{d as ye}from"./decalFragment-CTePFHgv.js";import{l as Ge}from"./lightFragment-DzkxxTiD.js";import"./index-gcnlu8d0.js";import"./publicPath-DFnRRUbl.js";const i="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
`;e.ShadersStoreWGSL[O]||(e.ShadersStoreWGSL[O]=w);const na=[Se,me,z,K,Ie,Ae,pe,ge,$,Be,q,Ve,Z,J,j,be,Ce,Q,ee,ae,Ne,ie,Pe,re,he,Oe,Te,ne,fe,Ue,Le,_e,oe,te,ce,le,ye,We,He,xe,Xe,Ye,ke,we,ze,Ke,$e,de,Me,se,qe,ue,Ze,Je,je,Qe,Ge,ea,aa,ia,Ee,Re,De,ra,ve,Fe];for(const a of na)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const Ca={name:O,shader:w};export{Ca as pbrPixelShaderWGSL};
