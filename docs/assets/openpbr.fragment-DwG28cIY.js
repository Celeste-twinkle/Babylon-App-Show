...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const ye={name:t,shader:A},r="openpbrNormalMapFragmentFunctions",b=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=b);const ze={name:r,shader:b},n="openpbrConductorReflectance",N=`#define pbr_inline
...
`;e.ShadersStore[I]||(e.ShadersStore[I]=w);const Je=[de,me,H,ue,Ge,B,V,pe,he,Re,Le,Oe,k,Y,xe,Z,$,j,Ce,ge,q,K,Q,Ie,J,Pe,ee,Me,Se,Te,ie,oe,Ae,ae,ye,ze,te,re,Ue,We,ne,se,Xe,ce,be,we,He,Be,le,fe,Ve,ke,Ye,Ze,ve,$e,je,qe,Ke,_e,De,Ne,Qe,Ee,Fe];for(const i of Je)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const fi={name:I,shader:w};export{fi as openpbrPixelShader};
