import{v as e,a0 as r,W as a,a5 as o,a2 as c,a9 as f,ad as s,ae as v}from"./thinEngine-B6AJuPpk.js";import{f as d,a as u}from"./fogVertex-BZ3dnur9.js";import"./index-bTSCevfz.js";import"./publicPath-DFnRRUbl.js";const i="gridVertexShader",n=`attribute position: vec3f;attribute normal: vec3f;
#ifdef UV1
attribute uv: vec2f;
#endif
#ifdef UV2
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=n);const l=[r,a,o,d,c,f,u,s,v];for(const t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const I={name:i,shader:n};export{I as gridVertexShaderWGSL};
