import{J as e,ar as u,as as v,at as x,au as p,a4 as V,b4 as D,b5 as A,av as T,ax as E,ay as I,az as N,aA as U,aB as b,aC as _}from"./thinEngine-BHwOTIeJ.js";import{s as P}from"./sceneVertexDeclaration-2nvkB3e7.js";import"./index-B_x9s0rl.js";import"./publicPath-DFnRRUbl.js";const o="meshVertexDeclaration",l=`uniform mat4 world;uniform float visibility;
...
}`;e.ShadersStore[s]||(e.ShadersStore[s]=h);const z=[u,v,x,p,V,P,w,g,D,A,R,L,T,E,I,N,U,b,W,C,_];for(const a of z)e.IncludesShadersStore[a.name]||(e.IncludesShadersStore[a.name]=a.shader);const H={name:s,shader:h};export{H as shadowMapVertexShader};
