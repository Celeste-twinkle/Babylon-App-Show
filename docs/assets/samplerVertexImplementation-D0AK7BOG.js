import{J as e}from"./thinEngine-BHwOTIeJ.js";const i="uvAttributeDeclaration",v=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=v);const E={name:i,shader:v},n="prePassVertexDeclaration",o=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=o);const x={name:n,shader:o},r="samplerVertexDeclaration",a=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=a);const m={name:r,shader:a},t="vertexPullingVertex",u=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=u);const N={name:t,shader:u},s="prePassVertex",p=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=p);const S={name:s,shader:p},f="uvVariableDeclaration",_=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=_);const V={name:f,shader:_},d="samplerVertexImplementation",c=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=c);const U={name:d,shader:c};export{S as a,V as b,U as c,x as p,m as s,E as u,N as v};
