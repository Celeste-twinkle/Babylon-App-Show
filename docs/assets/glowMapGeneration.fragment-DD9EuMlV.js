import{S as i}from"./index-C55VdZlk.js";const e="glowMapGenerationPixelShader",a=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;i.ShadersStoreWGSL[e]||(i.ShadersStoreWGSL[e]=a);const r={name:e,shader:a};export{r as glowMapGenerationPixelShaderWGSL};
