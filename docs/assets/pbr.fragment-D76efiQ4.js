import{J as e,a5 as z,a6 as K,cv as $,dN as q,cx as Z,ap as J,af as Q,a3 as j,dO as ee,bg as ae,cy as ie,ab as re,a7 as ne,bh as fe,dP as oe,cz as te,cA as ce,cw as le,aq as de,cB as se,b0 as Ee,a$ as Re}from"./thinEngine-BHwOTIeJ.js";import{p as Se,o as me,t as Ce,d as ue,a as ve}from"./oitFragment-BNdvGQ8z.js";import{p as Ie}from"./pbrUboDeclaration-BqZlCJ3f.js";import{m as Ae}from"./mainUVVaryingDeclaration-BXDQnkSA.js";import{p as pe,a as Ne,b as Oe,c as Te,d as Le,e as _e,f as Me,g as De,h as Fe}from"./pbrDebug-DoawxF8n.js";import{l as ge,s as Pe,a as he,c as Ue}from"./clusteredLightingFunctions-8FmRN3SQ.js";import{f as be}from"./fogFragmentDeclaration-kZc8VRPq.js";import{d as ye}from"./decalFragment-_KqEkXyk.js";import{l as Ge}from"./lightFragment-BX4ocmWk.js";import"./index-B_x9s0rl.js";import"./publicPath-DFnRRUbl.js";const i="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=H);const je={name:v,shader:H},I="pbrBlockFinalLitComponents",x=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;e.ShadersStoreWGSL[O]||(e.ShadersStoreWGSL[O]=w);const na=[Se,me,z,K,Ie,Ae,pe,ge,$,Be,q,Ve,Z,J,Q,be,Ce,j,ee,ae,Ne,ie,Pe,re,he,Oe,Te,ne,fe,Ue,Le,_e,oe,te,ce,le,ye,We,He,xe,Xe,Ye,ke,we,ze,Ke,$e,de,Me,se,qe,ue,Ze,Je,Qe,je,Ge,ea,aa,ia,Ee,Re,De,ra,ve,Fe];for(const a of na)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const Ca={name:O,shader:w};export{Ca as pbrPixelShaderWGSL};
