import{O as e,ah as z,ai as K,cr as $,dt as q,ct as Z,a4 as J,an as j,U as Q,du as ee,bh as ae,cu as ie,ak as re,aj as ne,bi as fe,dv as oe,cv as te,cw as ce,cs as le,a5 as de,cx as se,b1 as Ee,a6 as Re}from"./index-D5Cn6YQI.js";import{p as Se,o as me,t as Ce,d as ue,a as ve}from"./oitFragment-DwKriMXn.js";import{p as Ie}from"./pbrUboDeclaration-CQlfdhKy.js";import{m as Ae}from"./mainUVVaryingDeclaration-Cgir-nB8.js";import{p as pe,a as Ne,b as Oe,c as Te,d as Le,e as _e,f as Me,g as De,h as Fe}from"./pbrDebug-f9p8DJZ_.js";import{l as ge,s as Pe,a as he,c as Ue}from"./clusteredLightingFunctions-BJg-9coj.js";import{f as be}from"./fogFragmentDeclaration-BcOF_7Js.js";import{d as ye}from"./decalFragment-BMMXqNno.js";import{l as Ge}from"./lightFragment-BwcSyGFM.js";const i="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
`;e.ShadersStoreWGSL[O]||(e.ShadersStoreWGSL[O]=w);const na=[Se,me,z,K,Ie,Ae,pe,ge,$,Be,q,Ve,Z,J,j,be,Ce,Q,ee,ae,Ne,ie,Pe,re,he,Oe,Te,ne,fe,Ue,Le,_e,oe,te,ce,le,ye,We,He,xe,Xe,Ye,ke,we,ze,Ke,$e,de,Me,se,qe,ue,Ze,Je,je,Qe,Ge,ea,aa,ia,Ee,Re,De,ra,ve,Fe];for(const a of na)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const Sa={name:O,shader:w};export{Sa as pbrPixelShaderWGSL};
