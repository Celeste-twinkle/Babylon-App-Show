import{v as e,ah as u,ai as v,aj as p,ak as x,Q as V,aY as D,aZ as A,al as T,an as E,ao as I,ap as N,aq as U,ar as _,as as P}from"./thinEngine-C6TEorKP.js";import{s as b}from"./sceneVertexDeclaration-Y65bMv4t.js";import"./index-gcnlu8d0.js";import"./publicPath-DFnRRUbl.js";const o="meshVertexDeclaration",l=`uniform mat4 world;uniform float visibility;
...
}`;e.ShadersStore[s]||(e.ShadersStore[s]=h);const z=[u,v,p,x,V,b,w,g,D,A,R,L,T,E,I,N,U,_,W,C,P];for(const a of z)e.IncludesShadersStore[a.name]||(e.IncludesShadersStore[a.name]=a.shader);const H={name:s,shader:h};export{H as shadowMapVertexShader};
