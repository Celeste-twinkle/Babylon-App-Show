import{J as e,ap as o,af as t,a3 as r,aq as f,b0 as c,a$ as s}from"./thinEngine-BHwOTIeJ.js";import{f as m}from"./fogFragmentDeclaration-kZc8VRPq.js";import{i as l}from"./imageProcessingCompatibility-CWU4-ghq.js";import"./index-B_x9s0rl.js";import"./publicPath-DFnRRUbl.js";const a="skyPixelShader",i=`varying vPositionW: vec3f;
#ifdef VERTEXCOLOR
...
`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=i);const u=[o,t,m,r,f,c,s,l];for(const n of u)e.IncludesShadersStoreWGSL[n.name]||(e.IncludesShadersStoreWGSL[n.name]=n.shader);const E={name:a,shader:i};export{E as skyPixelShaderWGSL};
