import{S as e}from"./index-BxIDpZYW.js";const o="lightFragmentDeclaration",r=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=r);const t="lightUboDeclaration",s=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=s);const a="shadowsFragmentFunctions",l=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=c);
