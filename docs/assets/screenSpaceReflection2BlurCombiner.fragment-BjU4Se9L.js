import{v as e,O as f,Y as a}from"./thinEngine-B6AJuPpk.js";import{s as l}from"./screenSpaceRayTrace-xAO4Pk1f.js";import"./index-bTSCevfz.js";import"./publicPath-DFnRRUbl.js";const t="screenSpaceReflection2BlurCombinerPixelShader",i=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>; 
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=i);const n=[f,a,l];for(const r of n)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const p={name:t,shader:i};export{p as screenSpaceReflection2BlurCombinerPixelShaderWGSL};
