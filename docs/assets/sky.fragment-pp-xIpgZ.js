import{O as e,a4 as o,an as t,U as r,a5 as f,b1 as c,a6 as s}from"./index-CN0J_0dT.js";import{f as m}from"./fogFragmentDeclaration-DX4veHYZ.js";import{i as l}from"./imageProcessingCompatibility-C-E8opbC.js";const a="skyPixelShader",i=`varying vPositionW: vec3f;
#ifdef VERTEXCOLOR
...
`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=i);const u=[o,t,m,r,f,c,s,l];for(const n of u)e.IncludesShadersStoreWGSL[n.name]||(e.IncludesShadersStoreWGSL[n.name]=n.shader);const g={name:a,shader:i};export{g as skyPixelShaderWGSL};
