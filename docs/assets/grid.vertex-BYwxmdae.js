import{J as e,aa as a,a5 as r,af as o,ac as c,aj as f,an as s,ao as v}from"./thinEngine-DydGsXfS.js";import{f as d,a as u}from"./fogVertex-Dhm8hd45.js";import"./index-Dsfomhyb.js";import"./publicPath-DFnRRUbl.js";const i="gridVertexShader",n=`attribute position: vec3f;attribute normal: vec3f;
#ifdef UV1
attribute uv: vec2f;
#endif
#ifdef UV2
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=n);const l=[a,r,o,d,c,f,u,s,v];for(const t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const I={name:i,shader:n};export{I as gridVertexShaderWGSL};
