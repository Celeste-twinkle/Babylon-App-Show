import{J as e,a4 as r,bj as n}from"./thinEngine-BHwOTIeJ.js";import{s as l}from"./screenSpaceRayTrace-DE0nV5fu.js";import"./index-B_x9s0rl.js";import"./publicPath-DFnRRUbl.js";const i="screenSpaceReflection2PixelShader",o=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=o);const c=[r,n,l];for(const t of c)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);const d={name:i,shader:o};export{d as screenSpaceReflection2PixelShader};
