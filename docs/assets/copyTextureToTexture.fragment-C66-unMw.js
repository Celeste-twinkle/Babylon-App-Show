import{O as e,U as n}from"./index-BSF9Ss3V.js";const o="copyTextureToTexturePixelShader",t=`uniform conversion: f32;
#ifndef NO_SAMPLER
...
`;e.ShadersStoreWGSL[o]||(e.ShadersStoreWGSL[o]=t);const a=[n];for(const r of a)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const u={name:o,shader:t};export{u as copyTextureToTexturePixelShaderWGSL};
