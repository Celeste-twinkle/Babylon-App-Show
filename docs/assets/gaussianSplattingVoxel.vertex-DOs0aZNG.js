import{v as a,aX as o,aY as r,aZ as n,a_ as l,b0 as s}from"./thinEngine-C6TEorKP.js";import"./index-gcnlu8d0.js";import"./publicPath-DFnRRUbl.js";const e="gaussianSplattingVoxelVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;a.ShadersStore[e]||(a.ShadersStore[e]=i);const p=[o,r,n,l,s];for(const t of p)a.IncludesShadersStore[t.name]||(a.IncludesShadersStore[t.name]=t.shader);const v={name:e,shader:i};export{v as gaussianSplattingVoxelVertexShader};
