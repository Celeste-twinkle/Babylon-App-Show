import{J as e,a5 as U,a6 as X,cv as H,dU as V,cx as B,ap as k,af as Y,a3 as Z,dV as j,bg as $,cy as q,ab as K,a7 as Q,bh as J,dW as ee,cw as re,dX as ae,dY as te,dZ as ie,aq as ne,d_ as oe,d$ as fe,b0 as se,a$ as le}from"./thinEngine-DydGsXfS.js";import{p as ce,o as _e,t as me,d as de,a as ue}from"./oitFragment-BDp48KgO.js";import{o as pe}from"./openpbrUboDeclaration-DZAjV8bt.js";import{m as ge}from"./mainUVVaryingDeclaration-DxGHclNj.js";import{p as ve,a as Ee,b as Se,c as he,d as Ie,e as Re,f as be,g as Ne,h as Te}from"./pbrDebug-IOHdd6EB.js";import{l as Ae,s as Le,a as Fe,c as De}from"./clusteredLightingFunctions-BcP6EPzt.js";import{f as Oe}from"./fogFragmentDeclaration-XsAPp1JC.js";import"./index-Dsfomhyb.js";import"./publicPath-DFnRRUbl.js";const a="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=x);const Be={name:p,shader:x},g="openpbrEnvironmentLighting",M=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
`;e.ShadersStoreWGSL[h]||(e.ShadersStoreWGSL[h]=w);const $e=[ce,_e,U,X,pe,ge,ve,Ae,H,V,Ce,B,k,Y,Oe,me,Z,j,$,Ee,q,Le,K,Fe,Se,he,Q,J,De,Ie,Re,ee,Pe,Ge,re,ae,xe,Me,te,ie,ye,ne,be,We,ze,we,oe,fe,Ue,Xe,He,Ve,de,Be,ke,Ye,Ze,se,le,Ne,je,ue,Te];for(const r of $e)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const nr={name:h,shader:w};export{nr as openpbrPixelShaderWGSL};
