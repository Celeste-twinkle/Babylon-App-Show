import{O as e,ah as o,ai as i,U as n,Z as s,an as l,b3 as f,a3 as u,as as d}from"./index-1Zx_PTkb.js";import{f as c,a as p}from"./fogVertex-9mr0iHaM.js";const r="gaussianSplattingVertexShader",a=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=a);const x=[o,i,n,s,c,l,f,u,p,d];for(const t of x)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const _={name:r,shader:a};export{_ as gaussianSplattingVertexShaderWGSL};
