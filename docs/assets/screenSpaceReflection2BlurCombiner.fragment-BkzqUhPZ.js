import{O as e,U as a,aj as f}from"./index-Cf6D-1pg.js";import{s as l}from"./screenSpaceRayTrace-D6jeyd4g.js";const t="screenSpaceReflection2BlurCombinerPixelShader",i=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>; 
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=i);const n=[a,f,l];for(const r of n)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const S={name:t,shader:i};export{S as screenSpaceReflection2BlurCombinerPixelShaderWGSL};
