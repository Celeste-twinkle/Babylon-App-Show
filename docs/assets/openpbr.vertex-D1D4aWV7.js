import{J as e,a5 as _,a6 as s,a3 as N,a7 as l,a8 as A,a9 as I,aa as c,ab as d,ac as M,ad as m,ae as u,af as f,ag as p,ah as R,ai as S,aj as V,ak as T,al as x,an as O,ao as D}from"./thinEngine-BHwOTIeJ.js";import{o as v}from"./openpbrUboDeclaration-OKXqY4Vp.js";import{u as G,p as F,s as C,v as L,a as W,b as U,c as g}from"./samplerVertexImplementation-D0AK7BOG.js";import{m as h}from"./mainUVVaryingDeclaration-BXDQnkSA.js";import{f as Y,a as P}from"./fogVertex-Dt7L1ltp.js";import{l as b,s as X}from"./shadowsVertex-B7onFy6M.js";import{v as y}from"./vertexColorMixing-Ba0VhU80.js";import"./index-B_x9s0rl.js";import"./publicPath-DFnRRUbl.js";const t="openpbrNormalMapVertexDeclaration",r=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=r);const B={name:t,shader:r},a="openpbrNormalMapVertex",o=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=o);const z={name:a,shader:o},i="openpbrVertexShader",E=`#define OPENPBR_VERTEX_SHADER
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=E);const H=[_,s,v,G,h,N,l,A,I,c,F,C,d,B,M,Y,b,m,u,f,p,L,R,S,V,T,x,W,U,g,z,O,P,X,y,D];for(const n of H)e.IncludesShadersStoreWGSL[n.name]||(e.IncludesShadersStoreWGSL[n.name]=n.shader);const ee={name:i,shader:E};export{ee as openpbrVertexShaderWGSL};
