import{O as e,b2 as N,b3 as l,W as A,bi as I,a7 as f,a8 as m,aa as c,bP as d,a9 as M,aE as u,aF as R,b5 as S,aG as p,aH as T,ab as O,ac as D,ad as V,ae as v,b7 as x}from"./index-DGx0eLww.js";import{s as C}from"./sceneVertexDeclaration-B0g_2jWC.js";import{d as F,u as h,p as G,s as g,l as U,a as L,b as P,c as Y,e as W}from"./samplerVertexImplementation-u2Gs6-_P.js";import{o as b}from"./openpbrUboDeclaration-BtMxaCOV.js";import{m as H}from"./mainUVVaryingDeclaration-3nNPmOBy.js";import{f as X,a as y}from"./fogVertex-DTgdKs_4.js";import{s as B}from"./shadowsVertex-BI-PzcY6.js";import{v as z}from"./vertexColorMixing-gc99-nQA.js";const n="openpbrVertexDeclaration",t=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=_);const K=[C,F,Z,N,l,b,h,H,A,I,f,m,c,G,g,d,k,M,X,U,L,u,R,S,p,T,O,D,V,P,Y,W,w,v,y,B,z,x];for(const i of K)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const oe={name:a,shader:_};export{oe as openpbrVertexShader};
