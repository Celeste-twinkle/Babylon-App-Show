import{v as r,am as t,ap as l}from"./thinEngine-C6TEorKP.js";import"./index-gcnlu8d0.js";import"./publicPath-DFnRRUbl.js";const i="greasedLineVertexShader",o=`precision highp float;
...
`;r.ShadersStore[i]||(r.ShadersStore[i]=o);const n=[t,l];for(const e of n)r.IncludesShadersStore[e.name]||(r.IncludesShadersStore[e.name]=e.shader);const c={name:i,shader:o};export{c as greasedLineVertexShader};
