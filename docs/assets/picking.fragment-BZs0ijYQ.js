import{O as d}from"./index-B_ELnFEh.js";const e="pickingPixelShader",o=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
precision highp int;
#endif
...
`;d.ShadersStore[e]||(d.ShadersStore[e]=o);const f={name:e,shader:o};export{f as pickingPixelShader};
