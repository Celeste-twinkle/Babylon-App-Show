import{J as t,a5 as i,a6 as o,b2 as s}from"./thinEngine-DydGsXfS.js";import"./index-Dsfomhyb.js";import"./publicPath-DFnRRUbl.js";const r="gaussianSplattingVoxelVertexShader",a=`#include<sceneUboDeclaration>
...
`;t.ShadersStoreWGSL[r]||(t.ShadersStoreWGSL[r]=a);const n=[i,o,s];for(const e of n)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);const d={name:r,shader:a};export{d as gaussianSplattingVoxelVertexShaderWGSL};
