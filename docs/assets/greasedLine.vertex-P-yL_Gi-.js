import{J as e,aa as l,a5 as n,a6 as o,aj as s}from"./thinEngine-BHwOTIeJ.js";import"./index-B_x9s0rl.js";import"./publicPath-DFnRRUbl.js";const t="greasedLineVertexShader",i=`#include<instancesDeclaration>
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=i);const f=[l,n,o,s];for(const r of f)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const d={name:t,shader:i};export{d as greasedLineVertexShaderWGSL};
