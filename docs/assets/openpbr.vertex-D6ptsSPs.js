import{v as e,aY as N,aZ as l,Q as A,ba as I,ah as f,ai as m,am as c,bI as d,al as M,aj as u,ak as R,a$ as S,an as p,ao as T,ap as O,aq as D,ar as V,as as v,b1 as x}from"./thinEngine-C6TEorKP.js";import{s as C}from"./sceneVertexDeclaration-Y65bMv4t.js";import{d as F,u as h,p as G,s as g,l as U,a as L,b as Y,c as P,e as W}from"./samplerVertexImplementation-QcZcL9ra.js";import{o as b}from"./openpbrUboDeclaration-iAh-PLCw.js";import{m as H}from"./mainUVVaryingDeclaration-BmblkGO3.js";import{f as X,a as y}from"./fogVertex-B_8mntLI.js";import{s as B}from"./shadowsVertex-CncdgkCJ.js";import{v as z}from"./vertexColorMixing-CVbTO3J3.js";import"./index-gcnlu8d0.js";import"./publicPath-DFnRRUbl.js";const n="openpbrVertexDeclaration",t=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=_);const K=[C,F,Z,N,l,b,h,H,A,I,f,m,c,G,g,d,k,M,X,U,L,u,R,S,p,T,O,D,V,Y,P,W,w,v,y,B,z,x];for(const i of K)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const ae={name:a,shader:_};export{ae as openpbrVertexShader};
