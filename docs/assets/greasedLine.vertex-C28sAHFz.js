import{O as r,aa as t,ab as l}from"./index-Ci6NqJw7.js";const i="greasedLineVertexShader",o=`precision highp float;
...
`;r.ShadersStore[i]||(r.ShadersStore[i]=o);const n=[t,l];for(const e of n)r.IncludesShadersStore[e.name]||(r.IncludesShadersStore[e.name]=e.shader);const a={name:i,shader:o};export{a as greasedLineVertexShader};
