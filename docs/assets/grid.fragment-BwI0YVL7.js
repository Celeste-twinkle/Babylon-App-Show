import{v as i,af as f,a5 as a,ag as s,aT as d,aU as l}from"./thinEngine-B6AJuPpk.js";import{f as c}from"./fogFragmentDeclaration-CwCan84O.js";import"./index-bTSCevfz.js";import"./publicPath-DFnRRUbl.js";const n="imageProcessingCompatibility",o=`#ifdef IMAGEPROCESSINGPOSTPROCESS
fragmentOutputs.color=vec4f(pow(fragmentOutputs.color.rgb, vec3f(2.2)),fragmentOutputs.color.a);
#endif
`;i.IncludesShadersStoreWGSL[n]||(i.IncludesShadersStoreWGSL[n]=o);const m={name:n,shader:o},r="gridPixelShader",t=`#define SQRT2 1.41421356
#define PI 3.14159
...
`;i.ShadersStoreWGSL[r]||(i.ShadersStoreWGSL[r]=t);const g=[f,a,c,s,d,l,m];for(const e of g)i.IncludesShadersStoreWGSL[e.name]||(i.IncludesShadersStoreWGSL[e.name]=e.shader);const v={name:r,shader:t};export{v as gridPixelShaderWGSL};
