import{O as e,ah as _,ai as s,U as N,aj as l,X as A,Y as I,$ as c,ak as d,Z as M,al as m,am as u,an as f,ao as p,ap as R,aq as S,a0 as V,a1 as T,a2 as x,a3 as O,as as D}from"./index-Cs7B0lc6.js";import{o as v}from"./openpbrUboDeclaration-DboJXbko.js";import{u as G,p as F,s as C,v as L,a as W,b as U,c as g}from"./samplerVertexImplementation-Br-GLpzz.js";import{m as h}from"./mainUVVaryingDeclaration-BQmmgNwt.js";import{f as Y,a as P}from"./fogVertex-CYDTZkKo.js";import{l as b,s as X}from"./shadowsVertex-BxOdGCll.js";import{v as y}from"./vertexColorMixing-CmdXDB4q.js";const t="openpbrNormalMapVertexDeclaration",r=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=E);const H=[_,s,v,G,h,N,l,A,I,c,F,C,d,B,M,Y,b,m,u,f,p,L,R,S,V,T,x,W,U,g,z,O,P,X,y,D];for(const n of H)e.IncludesShadersStoreWGSL[n.name]||(e.IncludesShadersStoreWGSL[n.name]=n.shader);const q={name:a,shader:E};export{q as openpbrVertexShaderWGSL};
