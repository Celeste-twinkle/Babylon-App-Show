import{J as e,a3 as f,a7 as o}from"./thinEngine-BHwOTIeJ.js";import{s as n}from"./screenSpaceRayTrace-CvumDot9.js";import"./index-B_x9s0rl.js";import"./publicPath-DFnRRUbl.js";const t="screenSpaceReflection2PixelShader",i=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;
#ifdef SSR_SUPPORTED
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=i);const a=[f,o,n];for(const r of a)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const v={name:t,shader:i};export{v as screenSpaceReflection2PixelShaderWGSL};
