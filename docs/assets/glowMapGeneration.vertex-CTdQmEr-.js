import{O as e,X as r,Y as n,al as f,am as o,Z as s,$ as d,ap as u,aq as v,a0 as c,a1 as x,a2 as p,a3 as l}from"./index-C_bQx8DG.js";const i="glowMapGenerationVertexShader",a=`attribute position: vec3f;
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=a);const V=[r,n,f,o,s,d,u,v,c,x,p,l];for(const t of V)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const S={name:i,shader:a};export{S as glowMapGenerationVertexShaderWGSL};
