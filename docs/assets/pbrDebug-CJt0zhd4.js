import{O as e}from"./index-B_G2Vpay.js";import"./mainUVVaryingDeclaration-Crvn2Xa2.js";import"./clusteredLightingFunctions-BaRQsfYY.js";const t="pbrFragmentExtraDeclaration",s=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=s);const O={name:t,shader:s},i="pbrHelperFunctions",d=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=d);const C={name:i,shader:d},r="pbrDirectLightingSetupFunctions",u=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=L);const G={name:c,shader:L};export{C as a,S as b,R as c,T as d,N as e,I as f,M as g,G as h,O as p};
