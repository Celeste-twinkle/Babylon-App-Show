import{v as e}from"./thinEngine-C6TEorKP.js";const t="prePassDeclaration",v=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=v);const p={name:t,shader:v},a="oitDeclaration",s=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=s);const u={name:a,shader:s},r="decalFragmentDeclaration",f=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=f);const E={name:r,shader:f},o="textureRepetitionFunctions",i=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=i);const h={name:o,shader:i},d="depthPrePass",n=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=n);const T={name:d,shader:n},c="oitFragment",l=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=l);const R={name:c,shader:l};export{T as a,R as b,E as d,u as o,p,h as t};
