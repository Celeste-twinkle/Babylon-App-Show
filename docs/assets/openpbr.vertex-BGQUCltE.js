import{v as e,W as _,X as s,O as N,Y as l,Z as A,$ as I,a0 as c,a1 as d,a2 as M,a3 as m,a4 as u,a5 as f,a6 as p,a7 as R,a8 as S,a9 as V,aa as T,ab as x,ad as O,ae as D}from"./thinEngine-C6TEorKP.js";import{o as v}from"./openpbrUboDeclaration-sZZlW6LD.js";import{u as G,p as F,s as C,v as L,a as W,b as U,c as g}from"./samplerVertexImplementation-ZvccyBgl.js";import{m as h}from"./mainUVVaryingDeclaration-Bjufdkcf.js";import{f as Y,a as P}from"./fogVertex-Dtyxkiw_.js";import{l as b,s as X}from"./shadowsVertex-g7Ms2qVt.js";import{v as y}from"./vertexColorMixing-CfxUUCVg.js";import"./index-gcnlu8d0.js";import"./publicPath-DFnRRUbl.js";const t="openpbrNormalMapVertexDeclaration",r=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=r);const B={name:t,shader:r},i="openpbrNormalMapVertex",o=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=o);const z={name:i,shader:o},a="openpbrVertexShader",E=`#define OPENPBR_VERTEX_SHADER
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=E);const H=[_,s,v,G,h,N,l,A,I,c,F,C,d,B,M,Y,b,m,u,f,p,L,R,S,V,T,x,W,U,g,z,O,P,X,y,D];for(const n of H)e.IncludesShadersStoreWGSL[n.name]||(e.IncludesShadersStoreWGSL[n.name]=n.shader);const ee={name:a,shader:E};export{ee as openpbrVertexShaderWGSL};
