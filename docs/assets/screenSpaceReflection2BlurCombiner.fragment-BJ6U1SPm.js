import{J as e,a3 as a,a7 as f}from"./thinEngine-DydGsXfS.js";import{s as l}from"./screenSpaceRayTrace-BjfNMSYz.js";import"./index-Dsfomhyb.js";import"./publicPath-DFnRRUbl.js";const t="screenSpaceReflection2BlurCombinerPixelShader",i=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>; 
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=i);const n=[a,f,l];for(const r of n)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const p={name:t,shader:i};export{p as screenSpaceReflection2BlurCombinerPixelShaderWGSL};
