import{J as e,a4 as o,bj as t}from"./thinEngine-BHwOTIeJ.js";import{s as n}from"./screenSpaceRayTrace-DE0nV5fu.js";import"./index-B_x9s0rl.js";import"./publicPath-DFnRRUbl.js";const i="screenSpaceReflection2BlurCombinerPixelShader",l=`uniform sampler2D textureSampler; 
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=l);const c=[o,t,n];for(const r of c)e.IncludesShadersStore[r.name]||(e.IncludesShadersStore[r.name]=r.shader);const p={name:i,shader:l};export{p as screenSpaceReflection2BlurCombinerPixelShader};
