import{O as e,$ as a,ah as r,an as o,Z as c,a0 as f,a3 as s,as as v}from"./index-DGx0eLww.js";import{f as d,a as u}from"./fogVertex-D6lruBZw.js";const i="gridVertexShader",n=`attribute position: vec3f;attribute normal: vec3f;
#ifdef UV1
attribute uv: vec2f;
#endif
#ifdef UV2
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=n);const l=[a,r,o,d,c,f,u,s,v];for(const t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const S={name:i,shader:n};export{S as gridVertexShaderWGSL};
