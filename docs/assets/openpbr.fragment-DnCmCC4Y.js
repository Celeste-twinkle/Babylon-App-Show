import{v as e,W as U,X,ci as H,dn as B,ck as V,af as k,a5 as Y,O as Z,dp as j,dq as $,cl as q,a1 as K,Y as Q,dr as J,ds as ee,cj as re,dt as ae,du as te,dv as ie,ag as ne,dw as oe,dx as fe,aU as se,aT as le}from"./thinEngine-B6AJuPpk.js";import{p as ce,o as _e,t as me,d as de,a as ue}from"./oitFragment-C8eOgBME.js";import{o as pe}from"./openpbrUboDeclaration-DLb-l6QQ.js";import{m as ge}from"./mainUVVaryingDeclaration-eYk_dlx5.js";import{p as ve,a as Ee,b as Se,c as he,d as Ie,e as Re,f as be,g as Te,h as Ne}from"./pbrDebug-DYY1TLeY.js";import{l as Ae,s as Le,a as Fe,c as De}from"./clusteredLightingFunctions-otV62G7z.js";import{f as Oe}from"./fogFragmentDeclaration-CwCan84O.js";import"./index-bTSCevfz.js";import"./publicPath-DFnRRUbl.js";const a="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=b);const Ge={name:i,shader:b},n="openpbrConductorReflectance",T=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=T);const xe={name:n,shader:T},o="openpbrAmbientOcclusionFunctions",N=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=N);const Me={name:o,shader:N},f="openpbrVolumeFunctions",A=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=L);const ye={name:s,shader:L},l="openpbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=M);const ke={name:g,shader:M},v="openpbrDirectLightingInit",W=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=W);const Ye={name:v,shader:W},E="openpbrDirectLighting",y=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=y);const Ze={name:E,shader:y},S="openpbrBlockPrePass",z=`#if SCENE_MRT_COUNT>0
...
`;e.ShadersStoreWGSL[h]||(e.ShadersStoreWGSL[h]=w);const $e=[ce,_e,U,X,pe,ge,ve,Ae,H,B,Ce,V,k,Y,Oe,me,Z,j,$,Ee,q,Le,K,Fe,Se,he,Q,J,De,Ie,Re,ee,Pe,Ge,re,ae,xe,Me,te,ie,We,ne,be,ye,ze,we,oe,fe,Ue,Xe,He,Be,de,Ve,ke,Ye,Ze,se,le,Te,je,ue,Ne];for(const r of $e)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const nr={name:h,shader:w};export{nr as openpbrPixelShaderWGSL};
