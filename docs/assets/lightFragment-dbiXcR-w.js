import{J as e}from"./thinEngine-BHwOTIeJ.js";const i="clusteredLightingFunctions",o=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=o);const h={name:i,shader:o},t="lightFragment",n=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);const s={name:t,shader:n};export{h as c,s as l};
