import{v as e}from"./thinEngine-C6TEorKP.js";import"./mainUVVaryingDeclaration-Bjufdkcf.js";import"./clusteredLightingFunctions-Dq6q3jg1.js";const t="pbrFragmentExtraDeclaration",s=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=s);const C={name:t,shader:s},i="pbrHelperFunctions",d=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=d);const O={name:i,shader:d},r="pbrDirectLightingSetupFunctions",u=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=u);const S={name:r,shader:u},o="pbrDirectLightingFalloffFunctions",g=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=g);const R={name:o,shader:g},f="pbrBlockReflectance0",h=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=h);const T={name:f,shader:h},n="pbrDirectLightingFunctions",E=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=E);const N={name:n,shader:E},a="pbrBlockNormalGeometric",v=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=v);const I={name:a,shader:v},l="pbrBlockImageProcessing",p=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=p);const M={name:l,shader:p},c="pbrDebug",L=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=L);const G={name:c,shader:L};export{O as a,S as b,R as c,T as d,N as e,I as f,M as g,G as h,C as p};
