import{O as e,$ as l,ah as n,ai as o,a0 as s}from"./index-CFD21-UM.js";const t="greasedLineVertexShader",i=`#include<instancesDeclaration>
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=i);const f=[l,n,o,s];for(const r of f)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const g={name:t,shader:i};export{g as greasedLineVertexShaderWGSL};
