import{v as e}from"./thinEngine-C6TEorKP.js";import"./mainUVVaryingDeclaration-BmblkGO3.js";import"./ltcHelperFunctions-BChwv6nf.js";const t="pbrFragmentExtraDeclaration",c=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);const A={name:t,shader:c},o="pbrHelperFunctions",s=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=s);const v={name:o,shader:s},i="pbrDirectLightingSetupFunctions",d=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=d);const m={name:i,shader:d},r="pbrDirectLightingFalloffFunctions",g=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=g);const O={name:r,shader:g},a="pbrDirectLightingFunctions",u=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=u);const M={name:a,shader:u},l="pbrBlockNormalGeometric",E=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=E);const N={name:l,shader:E},n="pbrBlockImageProcessing",h=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=h);const R={name:n,shader:h},f="pbrDebug",D=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=D);const T={name:f,shader:D};export{v as a,m as b,O as c,M as d,N as e,R as f,T as g,A as p};
