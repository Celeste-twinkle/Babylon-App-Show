import{O as i,a4 as o,an as t,a5 as f,a6 as a,b1 as s}from"./index-YATPwAeJ.js";import{f as d}from"./fogFragmentDeclaration-C3UUI-oZ.js";import{i as l}from"./imageProcessingCompatibility-Cmkg8gQR.js";const n="gridPixelShader",r=`#define SQRT2 1.41421356
#define PI 3.14159
...
`;i.ShadersStoreWGSL[n]||(i.ShadersStoreWGSL[n]=r);const c=[o,t,d,f,a,s,l];for(const e of c)i.IncludesShadersStoreWGSL[e.name]||(i.IncludesShadersStoreWGSL[e.name]=e.shader);const p={name:n,shader:r};export{p as gridPixelShaderWGSL};
