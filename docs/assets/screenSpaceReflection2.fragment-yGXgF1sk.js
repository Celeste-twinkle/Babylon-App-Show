import{O as e,U as f,aj as o}from"./index-boGQW7yX.js";import{s as n}from"./screenSpaceRayTrace-Mx-iJF7r.js";const t="screenSpaceReflection2PixelShader",i=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;
#ifdef SSR_SUPPORTED
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=i);const a=[f,o,n];for(const r of a)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const s={name:t,shader:i};export{s as screenSpaceReflection2PixelShaderWGSL};
