import{O as e,b5 as N,b6 as l,W as A,bk as I,a7 as f,a8 as m,aa as c,bR as d,a9 as M,aH as u,aI as R,b8 as S,aJ as p,aK as T,ab as O,ac as D,ad as V,ae as v,ba as x}from"./index-B_ELnFEh.js";import{s as C}from"./sceneVertexDeclaration-eqAfMQCx.js";import{d as F,u as h,p as G,s as g,l as U,a as L,b as Y,c as P,e as W}from"./samplerVertexImplementation-DCBZ_Wmp.js";import{o as b}from"./openpbrUboDeclaration-BgLtq_FS.js";import{m as H}from"./mainUVVaryingDeclaration-DUNglx-8.js";import{f as X,a as y}from"./fogVertex-BZOew-VV.js";import{s as B}from"./shadowsVertex-CAB0whF3.js";import{v as z}from"./vertexColorMixing-Cw4caYdK.js";const n="openpbrVertexDeclaration",t=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=_);const K=[C,F,Z,N,l,b,h,H,A,I,f,m,c,G,g,d,k,M,X,U,L,u,R,S,p,T,O,D,V,Y,P,W,w,v,y,B,z,x];for(const i of K)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const oe={name:a,shader:_};export{oe as openpbrVertexShader};
